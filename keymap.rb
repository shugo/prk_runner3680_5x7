...
kbd.add_layer :default, %i[
      KC_ESCAPE   KC_GRV   KC_1     KC_2     KC_3     KC_4     KC_5         KC_6     KC_7     KC_8     KC_9     KC_0     KC_MINUS  KC_EQL
      KC_TAB   KC_TAB   KC_Q     KC_W     KC_E     KC_R     KC_T         KC_Y     KC_U     KC_I     KC_O     KC_P     KC_LBRC  KC_RBRC
      KC_LCTL  KC_LCTL  KC_A     KC_S     KC_D     KC_F     KC_G         KC_H     KC_J     KC_K     KC_L     KC_SCOLON  KC_QUOT  KC_BSLS
      KC_PGUP  KC_LSFT  KC_Z     KC_X     KC_C     KC_V     KC_B         KC_N     KC_M     KC_COMM  KC_DOT   KC_SLSH  KC_ENT  KC_RSFT
      KC_PGDN  ADJUST   KC_LGUI  KC_LALT  KC_LGUI  LOWER    KC_SPACE       KC_BSPACE  RAISE    KC_INS   KC_HOME  KC_END   KC_DEL   KC_RCTL
]
...
kbd.add_layer :raise, %i[
    ...
    KC_PLUS  KC_NO    KC_F1    KC_F2    KC_F3    KC_F4    KC_F5        KC_F6    KC_MINUS  KC_EQL   KC_LBRC  KC_RBRC  KC_NO    KC_NO
...
kbd.add_layer :adjust, %i[
    ...
    KC_NO    KC_NO    RESET    RGB_TOG  RGB_MOD  RGB_HUD  RGB_HUI      RGB_SAD  RGB_SAI  RGB_VAD  RGB_VAI  KC_NO    KC_DEL   KC_NO
